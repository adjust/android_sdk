...
public class UtilNetworking {
    ...
    private static String extractNativeProtocol(final Map<String, String> parameters) {
        return parameters.remove("native_protocol");
    }
    ...
    private static String buildAuthorizationHeader(final Map<String, String> parameters,
        ...
        String nativeProtocol = extractNativeProtocol(parameters);
        ...
        String authorizationHeader = buildAuthorizationHeaderV2(signature, secretId,
                headersId, nativeProtocol, nativeVersion);
        if (authorizationHeader != null) {
    ...
    private static String buildAuthorizationHeaderV2(final String signature,
        ...
        String algorithmHeader = Util.formatString("algorithm=\"%s\"", nativeProtocol != null ? nativeProtocol : "adj1");
