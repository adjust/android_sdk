...
public class HttpRequestHandler extends HandlerThread implements RequestHandler {
    ...
    private static final class InternalHandler extends Handler {
        ...
        private final WeakReference<HttpRequestHandler> requestHandlerReference;

        protected InternalHandler(Looper looper, HttpRequestHandler requestHandler) {
            super(looper);
            this.requestHandlerReference = new WeakReference<HttpRequestHandler>(requestHandler);
        }
        ...
        public void handleMessage(Message message) {
            ...
            HttpRequestHandler requestHandler = requestHandlerReference.get();
